...
unless ApplicationHelper.included_modules.include?(RedminePerProjectFormatting::ApplicationHelperPatch)
  ApplicationHelper.send(:include, RedminePerProjectFormatting::ApplicationHelperPatch)
end